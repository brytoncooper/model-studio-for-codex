...
def _support_directory(home=None):
    support = (Path(home) if home is not None else Path.home()) / "Library/Application Support"
    current = support / "Model Deck"
    legacy = support / "Codex OpenRouter"
...
def runtime_directory():
    return _support_directory() / "cursor-sdk"
...
def catalog_cache_path():
    return runtime_directory().parent / CATALOG_CACHE_NAME
